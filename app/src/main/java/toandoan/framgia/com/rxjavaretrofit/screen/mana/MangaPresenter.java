...
final class MangaPresenter implements MangaContract.Presenter {
    ...
    public MangaPresenter(MangaContract.ViewModel viewModel, String type,
            MangaDataSource mangaRepository, SourcesDataSource sourcesRepository) {
    ...
    public void getData() {
        ...
        Subscription subscription = mMangaRepository.getPopularManga(sourceSlug, mType, mPage)
