package toandoan.framgia.com.rxjavaretrofit.utils.widget.itemtouch;
...
public class ItemTouchHelperExtension extends RecyclerView.ItemDecoration
     ...
     * {@link com.loopeer.itemtouchhelperextension.ItemTouchHelperExtension.Callback#isLongPressDragEnabled()}.
     * <p>
     ...
     * ItemTouchHelper
     * is attached.</li>
     * <li>{@link com.loopeer.itemtouchhelperextension.ItemTouchHelperExtension.Callback} must have dragging enabled.</li>
     ...
     *                   RecyclerView.
     * @see com.loopeer.itemtouchhelperextension.ItemTouchHelperExtension.Callback#isItemViewSwipeEnabled()
     */
     ...
     * behavior
     * by overriding {@link com.loopeer.itemtouchhelperextension.ItemTouchHelperExtension.Callback}
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * ItemTouchHelper is attached.</li>
     * <li>{@link com.loopeer.itemtouchhelperextension.ItemTouchHelperExtension.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the ItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events, this should work as expected.</li>
     * </ul>
     ...
     * {@link com.loopeer.itemtouchhelperextension.ItemTouchHelperExtension}.
     */
    public static interface ViewDropHandler {

        /**
         * Called by the {@link com.loopeer.itemtouchhelperextension.ItemTouchHelperExtension} after a View is dropped over another View.
         * <p>
    ...
    public abstract static class Callback {
         ...
         *                    it is cleared.
         * @param actionState One of {@link com.loopeer.itemtouchhelperextension.ItemTouchHelperExtension#ACTION_STATE_IDLE},
         *                    {@link com.loopeer.itemtouchhelperextension.ItemTouchHelperExtension#ACTION_STATE_SWIPE} or
         *                    {@link com.loopeer.itemtouchhelperextension.ItemTouchHelperExtension#ACTION_STATE_DRAG}.
